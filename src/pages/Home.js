...
import image from '../IMG_2178-copy.png'
...
const Home= () => {
    ...
    return(
        <div className="body-divs">
            ...
            <br/>
            <br/>
            Outside of my job and hobbies, you can find me weight training at the gym, running, cycling, cooking with loved ones, trying various ethnic restaurants around the city, or relaxing at uptown parks landscape or birdwatching.</p>
        </div>
    )
}
