        ...
        <div className="body-divs">
            ...
            <div className="aboutme">
                ...
                <div className="aboutme-blocks">
                    ...
                    <br/>
                    <br/>
                    Some of the current projects I am working on include the following:  </p>
                    <p className="body-texts bold-and-left" style={{display: 'inline'}}>1 - </p>A sign up application for a special event I will be hosting in the fall of 2023 for when I turn exactly 10,000 days old!
                    <br/>
                    <br/>
                    <p className="body-texts bold-and-left" style={{display: 'inline'}}>2 - </p>
                    ...
                    <br/>
                    <br/>
                    <p className="body-texts bold-and-left" style={{display: 'inline'}}>3 - </p>
